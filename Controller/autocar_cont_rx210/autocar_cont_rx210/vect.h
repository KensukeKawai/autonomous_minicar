...
// ICU IRQ0
#pragma interrupt (Excep_ICU_IRQ0(enable,vect=64))
void Excep_ICU_IRQ0(void);

// ICU IRQ1
#pragma interrupt (Excep_ICU_IRQ1(enable,vect=65))
...
// ICU IRQ3
#pragma interrupt (Excep_ICU_IRQ3(enable,vect=67))
void Excep_ICU_IRQ3(void);

// ICU IRQ4
#pragma interrupt (Excep_ICU_IRQ4(enable,vect=68))
...
// ICU IRQ6
#pragma interrupt (Excep_ICU_IRQ6(enable,vect=70))
void Excep_ICU_IRQ6(void);

// ICU IRQ7
#pragma interrupt (Excep_ICU_IRQ7(enable,vect=71))
