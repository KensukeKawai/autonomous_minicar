...
// SCI5 RXI5
#pragma interrupt (Excep_SCI5_RXI5(enable,vect=223))
void Excep_SCI5_RXI5(void);

// SCI5 TXI5
#pragma interrupt (Excep_SCI5_TXI5(enable,vect=224))
...
// SCI6 RXI6
#pragma interrupt (Excep_SCI6_RXI6(enable,vect=227))
void Excep_SCI6_RXI6(void);

// SCI6 TXI6
#pragma interrupt (Excep_SCI6_TXI6(enable,vect=228))
...
// SCI9 RXI9
#pragma interrupt (Excep_SCI9_RXI9(enable,vect=235))
void Excep_SCI9_RXI9(void);

// SCI9 TXI9
#pragma interrupt (Excep_SCI9_TXI9(enable,vect=236))
